        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="<%= product.getImageUrl() != null ? product.getImageUrl() : 'https://via.placeholder.com/300x400' %>" alt="<%= product.getName() %>">
                </div>
...
<main>
    <section class="products">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="<%= product.getImageUrl() != null ? product.getImageUrl() : "https://via.placeholder.com/300x400" %>" alt="<%= product.getName() != null ? product.getName() : "Product Image" %>">
                </div>
                <h3><%= product.getName() != null ? product.getName() : "Unknown Product" %></h3>
                <p>Rs. <%= product.getPrice() %></p>
                <a href="productDetails?productId=<%= product.getProductID() %>" class="btn secondary">View Details</a>
            </div>
            <%

...
<main>
    <section class="admin-products">
        ...
        <div class="product-grid">
            ...
            <div class="product-card">
                <div class="product-image">
                    <img src="<%= p.getImageUrl() != null ? p.getImageUrl() : "https://via.placeholder.com/300x400" %>" alt="<%= p.getName() != null ? p.getName() : "Product Image" %>">
                </div>
                <h3><%= p.getName() != null ? p.getName() : "Unknown Product" %></h3>
                <p class="description"><%= p.getDescription() != null ? p.getDescription() : "No description" %></p>
                <p>Price: Rs. <%= p.getPrice() %></p>
                <p>Stock: <%= p.getStock() %></p>
                <p>Category ID: <%= p.getCategoryID() %></p>
                <p>Admin ID: <%= p.getAdminID() %></p>
